                    ...
                    <div class="column">
                        <div class="contact-info">
                            <div class="contact-info-text">
                                ...
                                <span>+34653226598</span>
                            </div>
                            <div class="contact-info-text">
                                <svg viewBox="0 0 24 24">
                                    <path fill="currentColor" d="M20,8L12,13L4,8V6L12,11L20,6M20,4H4C2.89,4 2,4.89 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6C22,4.89 21.1,4 20,4Z" />
                                </svg>
                                <span>info@eyesl.com</span>
                            </div>
                            <div class="contact-info-text">
                                <svg viewBox="0 0 24 24">
                                    <path fill="currentColor" d="M12,11.5A2.5,2.5 0 0,1 9.5,9A2.5,2.5 0 0,1 12,6.5A2.5,2.5 0 0,1 14.5,9A2.5,2.5 0 0,1 12,11.5M12,2A7,7 0 0,0 5,9C5,14.25 12,22 12,22C12,22 19,14.25 19,9A7,7 0 0,0 12,2Z" />
                                </svg>
                                <span>Club Marítimo, Palma de Mallorca</span>
                            </div>
                            <div class="contact-info-text">
                                <svg viewBox="0 0 24 24">
                                ...
                                <span>Abierto Viernes y Sábados</span>
                            </div>
                            <div class="contact-info-text">
                                <svg viewBox="0 0 24 24">
                                    <path fill="currentColor" d="M12 2C6.5 2 2 6.5 2 12C2 17.5 6.5 22 12 22C17.5 22 22 17.5 22 12S17.5 2 12 2M7.7 15.5L7 14.2L11 11.9V7H12.5V12.8L7.7 15.5Z" />
                                </svg>
                                <span>23:59 - 6:00</span>
                            </div>
                        </div>
                    </div>
                    <div class="column">
